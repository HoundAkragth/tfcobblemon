...
import com.kingtrapinch.tfcobblemon.item.ModCreativeModeTabs;
...
public class TFCobblemon {
    ...
    public TFCobblemon(IEventBus modEventBus, ModContainer modContainer) {
        ...
        // Note that this is necessary if and only if we want *this* class (TFCobblemon) to respond directly to events.
